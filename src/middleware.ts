...
const publicPaths = ["/login", "/api/auth", "/api/bot/cron", "/api/bot/screen", "/api/bot/morning", "/api/config", "/api/admin/migrate", "/api/admin/audit-pnl", "/api/admin/verify-pnl", "/manifest.json"];
